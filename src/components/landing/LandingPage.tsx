...
function HeroPattern() {
  return (
    ...
    >
      ...
      {/* Row 5 — bleeds off bottom */}
      <rect x="-20" y="440" width="58" height="250" rx="3" fill="#E2D0BC"/><rect x="42" y="444" width="84" height="250" rx="3" fill="#ECDAC6"/><rect x="130" y="438" width="46" height="250" rx="3" fill="#D6C4B0"/><rect x="180" y="442" width="94" height="250" rx="3" fill="#E8D5C0"/><rect x="278" y="438" width="60" height="250" rx="3" fill="#DCCCB8"/><rect x="342" y="442" width="70" height="250" rx="3" fill="#E4D2BC"/><rect x="416" y="444" width="50" height="250" rx="3" fill="#D2C2AE"/><rect x="470" y="438" width="86" height="250" rx="3" fill="#EAD8C2"/><rect x="560" y="442" width="54" height="250" rx="3" fill="#DECEBE"/><rect x="618" y="444" width="76" height="250" rx="3" fill="#E6D4C0"/><rect x="698" y="438" width="46" height="250" rx="3" fill="#D4C4B0"/><rect x="748" y="442" width="90" height="250" rx="3" fill="#ECDCC8"/><rect x="842" y="444" width="58" height="250" rx="3" fill="#E0D0BC"/><rect x="904" y="438" width="66" height="250" rx="3" fill="#D8C8B2"/><rect x="974" y="442" width="50" height="250" rx="3" fill="#E4D2BC"/><rect x="1028" y="444" width="80" height="250" rx="3" fill="#ECDAC6"/><rect x="1112" y="438" width="108" height="250" rx="3" fill="#DAC8B4"/>
    </svg>
  );
}
